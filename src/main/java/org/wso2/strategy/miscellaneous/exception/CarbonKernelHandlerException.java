...
*/
package org.wso2.strategy.miscellaneous.exception;

/**
 * a Java application exception class which extends the java.lang.Exception class
 */
public class CarbonKernelHandlerException extends Exception {
    private String message;

    public CarbonKernelHandlerException(String message, Exception exception) {
